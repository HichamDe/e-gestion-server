                    ...
                    <div
                        ...
                        <div class="px-5 pb-5">
                            ...
                            <div>
                                ...
                                <input placeholder="quantity" class="w-[100%] rounded" value="1" type="number"
                                    name="qnt">
                            ...
                            <div class="flex items-center justify-between mt-2">
                                <span
                                    class="text-3xl font-bold text-gray-900 dark:text-white">${{ $prod->prix_u }}</span>
                                <button type="submit"
